        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <i>
                <b className="purple"> C, C++, Javascript React ,Redux and Typescript. </b>
              </i>
              <br />
              <br />
        ...
        <Row>
          <Col md={12} className="home-about-social">
            ...
            <p>
              ...
              <p>
              <a style={{color:"white", textDecoration:"none"}} href="karinakhairnar@gmail.com">karinakhairnar@gmail.com</a></p>
            </p>
